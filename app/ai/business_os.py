...
_EVENT_TAXONOMY: dict[str, dict[str, Any]] = {
    ...
    "service_request_created": {
        ...
        "loop": "conversao",
        "agent": "agente_atendimento",
        "required_metadata": ["service_id", "requester_user_id"],
        "default_risk": "low",
    },
    "service_request_denied": {
        ...
        "loop": "risco_eficiencia",
        "agent": "agente_atendimento",
        "required_metadata": ["reason", "service_id"],
        "default_risk": "medium",
    },
    "service_request_responded": {
        ...
        "loop": "conversao",
        "agent": "agente_atendimento",
        "required_metadata": ["service_request_id", "actor_user_id"],
        "default_risk": "low",
    },
    "service_request_scheduled": {
        ...
        "loop": "conversao",
        "agent": "agente_atendimento",
        "required_metadata": ["service_request_id", "scheduled_date"],
        "default_risk": "medium",
    },
