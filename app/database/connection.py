...
def _ensure_users_schema_compatibility() -> None:
    ...
    if IS_SQLITE:
        sqlite_statements = {
            ...
            "payment_billing_name": "ALTER TABLE users ADD COLUMN payment_billing_name VARCHAR(150)",
            "payment_billing_phone": "ALTER TABLE users ADD COLUMN payment_billing_phone VARCHAR(30)",
            "payment_billing_address_line1": "ALTER TABLE users ADD COLUMN payment_billing_address_line1 VARCHAR(255)",
            "payment_billing_address_line2": "ALTER TABLE users ADD COLUMN payment_billing_address_line2 VARCHAR(255)",
            "payment_billing_city": "ALTER TABLE users ADD COLUMN payment_billing_city VARCHAR(120)",
            "payment_billing_state": "ALTER TABLE users ADD COLUMN payment_billing_state VARCHAR(10)",
            "payment_billing_zip": "ALTER TABLE users ADD COLUMN payment_billing_zip VARCHAR(20)",
            "payment_billing_country": "ALTER TABLE users ADD COLUMN payment_billing_country VARCHAR(60)",
            "payment_pix_key_type": "ALTER TABLE users ADD COLUMN payment_pix_key_type VARCHAR(20)",
            "payment_pix_key": "ALTER TABLE users ADD COLUMN payment_pix_key VARCHAR(160)",
            "payment_pix_holder_name": "ALTER TABLE users ADD COLUMN payment_pix_holder_name VARCHAR(150)",
            "payment_card_holder_name": "ALTER TABLE users ADD COLUMN payment_card_holder_name VARCHAR(150)",
            "payment_card_last4": "ALTER TABLE users ADD COLUMN payment_card_last4 VARCHAR(4)",
            "payment_card_brand": "ALTER TABLE users ADD COLUMN payment_card_brand VARCHAR(30)",
            "payment_card_exp_month": "ALTER TABLE users ADD COLUMN payment_card_exp_month INTEGER",
            "payment_card_exp_year": "ALTER TABLE users ADD COLUMN payment_card_exp_year INTEGER",
            "payment_default_method": "ALTER TABLE users ADD COLUMN payment_default_method VARCHAR(20) DEFAULT 'card'",
            "payment_use_for_subscriptions": "ALTER TABLE users ADD COLUMN payment_use_for_subscriptions BOOLEAN DEFAULT 1",
            "payment_updated_at": "ALTER TABLE users ADD COLUMN payment_updated_at DATETIME",
